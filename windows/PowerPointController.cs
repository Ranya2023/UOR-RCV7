...
internal sealed class PowerPointController
{
    ...
    private Form? TopView =>
        ...
        QuizShowing ? _quizScreen : PickerShowing ? _picker : null;

    private string ViewName =>
        MediaShowing ? "media" : PhoneShowing ? "phone" : BoardShowing ? "board" : DocShowing ? "doc" :
        QuizShowing ? "quiz" : PickerShowing ? "picker" : "";
    ...
    private string ViewKey =>
        ...
        DocShowing ? _doc!.Key : QuizShowing ? "quiz" : PickerShowing ? "picker" : "";
    ...
    private void QuizUpdated()
    {
        ...
        _send(new
        {
            ...
            n = _quiz.OptionCount, counts, total = _quiz.Total, players = _quiz.PlayerCount,
    ...
    private void PollInner(Ctx? ctx)
    {
        ...
        int vPage = BoardShowing ? _board!.Page : DocShowing ? _doc!.Page : 0;
        int vPages = BoardShowing ? _board!.Pages : DocShowing ? _doc!.Pages : 0;
